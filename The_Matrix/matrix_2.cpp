...
const int sleepTime = 50; //it will take 50 milliseconds to print two successive //lines
...
int main() {
   ...
   const string ch = "1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz!@#$%^&*()_+{}|?><`~";
   const int l = ch.size();
